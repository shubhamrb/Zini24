...
public class OfferFragmentViewModel extends BaseViewModel<OfferFragmentNavigator> {

    public OfferFragmentViewModel(IDataManager dataManager, ISchedulerProvider schedulerProvider) {
        super(dataManager, schedulerProvider);
    }


    public void fetchOffers(Activity mActivity, JSONObject jsonObject) {
            ...
            getmDataManger().fetchOffers(mActivity, getmDataManger().getAccessToken(),jsonObject, new ResponseListener() {
                ...
                public void onSuccess(JsonObject jsonObject) {
                    try {
                        ...
                        getmNavigator().get().onSuccessOffers(jsonObject);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
