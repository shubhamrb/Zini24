...
public interface HistoryFragmentNavigator extends BaseNavigator {
    ...
    void onSuccessNewOrder(JsonObject jsonObject);
    void onSuccessSaveRating(JsonObject jsonObject, int position, float rating);
}
