...
public interface NearbyFragmentNavigator extends BaseNavigator {
    ...
    void onSuccessNearbyStores(JsonObject jsonObject);
    void onSuccessStoresByProduct(JsonObject jsonObject);
}
